...
global.AvatarHover = function () {
  var AsyncKeystate, css, defaultSettings, getSettings, handleFocusLoss, handleKeyUpDown, handleMouseOverOut, hoverCard, makeInput, qualifier, settings, updateHoverCard, updateQualifier;
  var lastTarget = null;
  ...
  handleKeyUpDown = function ({ key, target }) {
  ...
  handleMouseOverOut = function ({ type, target }) {
    lastTarget = ("mouseover" === type && target.tagName == 'IMG') ? target : null;
    updateHoverCard();
  };
